...
\c my_datawarehouse; 
\i E:/7_Data_Engineering_Projects/1_SQL_Data_WarehouseProject/scripts/silver/proc_load_silver.sql
...
-- execute command for sql server procedure:		EXEC Silver.load_silver;
